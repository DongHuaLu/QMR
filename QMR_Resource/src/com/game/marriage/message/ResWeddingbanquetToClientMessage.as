package com.game.marriage.message{
	...
	public class ResWeddingbanquetToClientMessage extends Message {
		...
		//今日累计送出红包
		private var _totalredenvelope: int;
		 ...
		 * @return 
		 */
		public function get totalredenvelope(): int{
			return _totalredenvelope;
		}
		
		/**
		 * set 今日累计送出红包
		 */
		public function set totalredenvelope(value: int): void{
			this._totalredenvelope = value;
		}
