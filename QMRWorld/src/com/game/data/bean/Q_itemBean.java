...
public class Q_itemBean {
	...
	//药品使用后关联BUFF编号列表（格式：BUFF编号;BUFF编号;BUFF编号）
	...
	/**
	 * get 药品使用后关联BUFF编号列表（格式：BUFF编号;BUFF编号;BUFF编号）
	 * @return 
	 */
	...
	/**
	 * set 药品使用后关联BUFF编号列表（格式：BUFF编号;BUFF编号;BUFF编号）
	 */
	...
	/**
	 * get 物品天生的名字颜色（0白色，1黄色，2绿色，3蓝色，4紫色）
	 * @return 
	 */
	...
	/**
	 * set 物品天生的名字颜色（0白色，1黄色，2绿色，3蓝色，4紫色）
	 */
