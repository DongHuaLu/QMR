...
//					player.getGold().getIsinner()==0&&
				...
				//MessageUtil.notify_All_player(Notifys.SROLL, "{1}玩家开启美人百宝袋获得8888元宝大奖",player.getName());
				//MessageUtil.notify_All_Activity(Notifys.CHAT_SYSTEM, 21, "{1}玩家开启美人百宝袋获得8888元宝大奖",player.getName());
				player.getActivitiesReward().put("mrbbdlasttime", System.currentTimeMillis()+"");
				MessageUtil.notify_player(player, Notifys.CHAT_BULL, ResManager.getInstance().getString("恭喜您开启美人百宝袋获得8888元宝大奖"));
				ParseUtil parseUtil = new ParseUtil();
				parseUtil.setValue(String.format(ResManager.getInstance().getString("玩家【%s】开启【美人百宝袋】获得8888元宝大奖，真是羡煞旁人！{@}"), player.getName()), new ParseUtil.VipParm(VipManager.getInstance().getPlayerVipId(player),GuideType.BAIBAODAI.getValue()));
