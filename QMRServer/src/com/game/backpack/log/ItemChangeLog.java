...
public class ItemChangeLog extends BaseLogBean {
	 ...
	 * @return
	 */
	public static ItemChangeLog createLog(String userId,long roleid, long itemid, int modelid, int num, String itembeforeInfo, String itemafterInfo, int reason,String action, long actionId, String changeAction,int sid) {
