...
public class ServerParamUtil {
	...
	public static String GUILDFLAG = "GUILDFLAG";//帮旗争夺战领地信息
	...
	public static void threadSaveNormal(String paramKey, String paramValue) {
		...
		if (NormalParamMap.containsKey(paramKey)) {
			...
			WServer.getInstance().getwSaveServerParamThread().dealServerParam(serverParam, SaveServerParamThread.ServerParam_UPDATE);
		} else {
			NormalParamMap.put(paramKey, paramValue);
			WServer.getInstance().getwSaveServerParamThread().dealServerParam(serverParam, SaveServerParamThread.ServerParam_INSERT);
		}
	}
